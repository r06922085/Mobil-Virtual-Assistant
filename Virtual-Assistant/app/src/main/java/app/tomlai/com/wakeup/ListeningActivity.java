...
public class ListeningActivity extends AppCompatActivity implements RecognitionListener {
    ...
    private static int sensibility = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //request for write setting, it just need to run for first time
    ...
    private void requestWriteSettings() {
        //it will lead to the interface of manual setting inorder to write setting
